...
//        return getName().equals(author.getName()) && getLastName().equals(author.getLastName());
        return getName().equals(author.getName()) && getLastName().equals(author.getLastName()) && getBirthdate().equals(author.getBirthdate()) && getCountry().equals(author.getCountry());
    }
